...
const colorInputt = document.getElementById("colorIntt");
colorInputt.addEventListener("input", function () {
  const selectedColor = colorInputt.value;
  const newDiv = document.createElement("div");
...
ColorBtn &&
  ColorBtn.addEventListener("click", function () {
    ...
    if (color == "red" || color == "green" || color == "blue") {
      ...
      alert("Iltimos, 'red', 'green' yoki 'blue', ranglarini kiriting!");
    }
  });
